...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-6">
              <span className="text-3xl font-heading font-bold text-white bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">
                InSocia
              </span>
            </Link>
            ...
            <div className="flex items-center space-x-4 mt-6">
              <a href="#" aria-label="Facebook" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800/60 text-neutral-400 hover:bg-primary-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                </svg>
              </a>
              <a href="#" aria-label="Twitter" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800/60 text-neutral-400 hover:bg-primary-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800/60 text-neutral-400 hover:bg-primary-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-800/60 text-neutral-400 hover:bg-primary-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Column 4: Contact Info with enhanced styling */}
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              ...
              <a href="tel:+917012345678" className="flex group">
                ...
                <div>
                  ...
                  <p className="text-neutral-400 group-hover:text-primary-400 transition-colors duration-300">+91 701 234 5678</p>
                </div>
              </a>
              
              <div className="flex group">
                <div className="mr-3 mt-1 w-9 h-9 flex-shrink-0 rounded-full bg-neutral-800/80 group-hover:bg-primary-600 flex items-center justify-center transition-all duration-300">
                  <svg className="w-4 h-4 text-neutral-400 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-neutral-400 group-hover:text-primary-400 transition-colors duration-300">Headquarters: Kozhikode</p>
                  <p className="text-neutral-400 group-hover:text-primary-400 transition-colors duration-300 mt-1">Regional Office: Bangalore</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Bottom Footer - Copyright and Credits with updated attribution */}
      <div className="relative z-10 bg-neutral-900/80 py-6 border-t border-neutral-800/60">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-neutral-500 text-sm">
              Designed and Developed by <a href="https://edotstudio.com" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 transition-colors font-medium hover:underline">EdotStudio</a>
            </div>
          </div>
        </div>
      </div>
