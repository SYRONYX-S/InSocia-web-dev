              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <a href="mailto:connect@insocia.in" className="group flex items-start space-x-3 p-3 rounded-xl bg-neutral-800/20 hover:bg-neutral-800/40 border border-neutral-700/20 hover:border-neutral-600/40 transition-all duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-300 text-sm group-hover:text-primary-400 transition-colors duration-300">connect@insocia.in</p>
                      </div>
                    </a>
                    ...
                    <div className="group flex items-start space-x-3 p-3 rounded-xl bg-neutral-800/20 border border-neutral-700/20">
                      ...
                      <div>
                        <p className="text-white font-medium text-sm">Our Locations</p>
                        <p className="text-neutral-300 text-sm">AECS Layout, Sanjayanagara, Bengaluru, Karnataka 560094</p>
                        <p className="text-neutral-300 text-sm">Kozhikode, Kerala - 673573</p>
                      </div>
                    </div>
